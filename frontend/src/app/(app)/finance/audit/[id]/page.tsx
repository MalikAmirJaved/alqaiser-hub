...
import { ArrowLeft, User, Calendar, Globe, FileText, Box } from "lucide-react";
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="capitalize">{log.source_module}</span>
            </div>
        ...
        <CardContent>
          {(!log.field_changes || log.field_changes.length === 0) ? (
            ...
            <Table>
              ...
              <TableBody>
                {log.field_changes.map((change: any) => (
