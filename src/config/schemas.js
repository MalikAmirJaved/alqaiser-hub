...
// Warehouse schema with location fields
warehouses: {
...
suppliers: {
  ...
  fields: [
    ...
    { key: "phone", label: "Phone", type: "text" },
    { key: "address_line", label: "Street Address", type: "textarea" },
    // Location fields - these will automatically render country/state/city dropdowns
    { key: "country", label: "Country", type: "country" },
    { key: "state", label: "State/Region", type: "state" },
    { key: "city", label: "City", type: "city" },
    { key: "postal_code", label: "Postal Code", type: "text" },
...
// Tax master tables configuration
    taxes: {
  ...
  employeeLoans: {
    ...
    fields: [
      { key: "employee_id", label: "Employee", type: "text", required: true },
      { key: "loan_type", label: "Loan Type", type: "select", options: ["Salary Advance", "Personal Loan", "Car Loan", "House Loan", "Education Loan"] },
      ...
      { key: "status", label: "Status", type: "select", options: ["PENDING", "ACTIVE", "PAID", "DEFAULTED"] },
      { key: "approved_by", label: "Approved By", type: "text" },
    ],
    columns: ["employee_id", "loan_type", "principal_amount", "monthly_deduction", "remaining_amount", "status"],
  },
  ...
  employeeBenefits: {
    ...
    fields: [
      { key: "employee_id", label: "Employee", type: "text", required: true },
      { key: "benefit_type", label: "Benefit Type", type: "select", options: ["Health Insurance", "Life Insurance", "Retirement Fund", "Children Education", "Transport"] },
      ...
      { key: "status", label: "Status", type: "select", options: ["PENDING", "ACTIVE", "CANCELLED"] },
    ],
    columns: ["employee_id", "benefit_type", "employer_contribution", "employee_contribution", "status"],
  },
