...
// Tax master tables configuration
    ...
    fields: [
      ...
      { key: "country", label: "Country", type: "select", options: ["PK", "US", "GB", "AE", "SA", "GLOBAL"], required: true },
      { key: "is_inclusive", label: "Tax Inclusive", type: "select", options: ["true", "false"] },
      { key: "tax_code", label: "Tax Code (FBR)", type: "text" },
  ...
  payroll: {
    ...
    subtitle: "Processed payroll history",
    storeKey: "payroll",
    idPrefix: "pay",
    fields: [
      ...
      { key: "status", label: "Status", type: "select", options: ["CALCULATED", "APPROVED", "PROCESSED", "PAID"] },
    ],
