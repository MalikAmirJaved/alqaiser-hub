...
from apps.inventory.audit import log_change   # ← corrected import
from .models import Account, JournalEntry, SupplierBill, CustomerInvoice, Payment
...
def finance_audit_post_save(sender, instance, created, **kwargs):
    ...
    log_change(
        ...
        user_id=user.id,
        before_state=None if created else instance,  # For updates you may want to capture previous state; we'll keep simple
